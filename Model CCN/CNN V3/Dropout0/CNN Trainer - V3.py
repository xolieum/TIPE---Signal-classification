...
# === Initialisation modèle et optimizer ===
model = SleepStageCNN(input_channels=1, input_length=x_np.shape[2], num_classes=NUM_CLASSES).to(device)
